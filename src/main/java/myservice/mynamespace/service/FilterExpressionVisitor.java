...
public class FilterExpressionVisitor implements ExpressionVisitor<Object> {
	...
	public Object visitMember(UriInfoResource arg0) throws ExpressionVisitException, ODataApplicationException {
		// To keeps things simple, this tutorial allows only primitive
		// properties.
		// We have faith that the java type of Edm.Int32 is Integer

		final List<UriResource> uriResourceParts = arg0.getUriResourceParts();
		...
		if (uriResourceParts.size() == 1 && uriResourceParts.get(0) instanceof UriResourcePrimitiveProperty) {
			...
			// For such cases the resource path returns a list of
			// UriResourceParts
